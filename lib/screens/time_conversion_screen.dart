...
class _TimeConversionScreenState extends State<TimeConversionScreen> {
  ...
  final Map<String, double> _conversionFactors = {
    'sec': 1.0, // 1 second = 1 second (base unit)
    'min': 60.0, // 1 minute = 60 seconds
    'hr': 3600.0, // 1 hour = 3600 seconds
    'day': 86400.0, // 1 day = 24 hours = 86400 seconds
    'wk': 604800.0, // 1 week = 7 days = 604800 seconds
    'mo': 2629746.0, // 1 month ≈ 30.44 days = 2629746 seconds (average)
    'yr': 31557600.0, // 1 year = 365.25 days = 31557600 seconds
  };

  final List<String> _units = ['sec', 'min', 'hr', 'day', 'wk', 'mo', 'yr'];
  ...
  void _convert() {
    ...
    try {
      ...
      // Convert to seconds (canonical base)
      final valueInSeconds = value * _conversionFactors[_fromUnit]!;

      // Convert from seconds to target unit
      final result = valueInSeconds / _conversionFactors[_toUnit]!;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CustomAppBar(title: 'Time / Duration'),
      body: Container(
